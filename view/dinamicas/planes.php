        ...
        <table>
            ...
            <thead>
                ...
                if (isset($_SESSION['Adm'])) {
                    ...
                    echo('<a href="" class="btn-btn-info">   Ver compras de Planes   </a>');
                } elseif (isset($_SESSION['Client'])) {
                    echo('<a href="index.php?c=Cliente" class="btn-btn-info">   Ver Planes adquiridos   </a>');
                }
                ?>
            <br></br>
            <tr>
                <th>Nombre de Plan</th><th>Operaciones</th>
            </tr>
            </thead>
            <?php
                ...
                <tr>
                    ...
                    <td >
                        ...
                        if (isset($_SESSION['Adm'])) {
                            ...
                            echo('<a href="index.php?c=Cliente&a=verPlanes" class="btn-btn-info">Plan</a>');
                        } elseif (isset($_SESSION['Client'])) {
